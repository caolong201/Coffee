...
public static class PlayerPrefsUtility
{
	...
	public static void SaveObject<ObjectType>(string key, ObjectType value)
	{
		PlayerPrefs.SetString(key, Serialize<ObjectType>(value));
	}
	...
	public static ObjectType LoadObject<ObjectType>(string key)
	{
		if (!PlayerPrefs.HasKey(key))
		{
		...
		return Deserialize<ObjectType>(PlayerPrefs.GetString(key));
	}
